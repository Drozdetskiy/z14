...
Список модов:
1. input_answers {'user_name':'user1','test_name':'test1','question_1':2,'question_2':2,'question_3':1}
...
def main(args):
    gt = gateway.Homework12Gateway()
    getattr(gt, args[1])(ast.literal_eval(args[2]))
    gt.connection.close()
